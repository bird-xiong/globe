...
export const Title = ({ sence }) => <View source={require('~/imgs/share_top_nav_bg.png')} style={{ borderRadius: 3, backgroundColor: Standard.color.black_bg, overflow: 'hidden', width: 180, height: 32, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
  <Image source={require('~/imgs/header_mars.png')} resizeMode="contain" />
  <Text style={{ color: Standard.color.wgray_main, paddingLeft: 5, fontSize: Standard.font.Small2 }}>|  地点 见闻 好物</Text>
</View>
